...
TEST(test, named_tuple)
{
  ...
  using configurable_v3_t = configurable_v2<a<100>, c<type::CCC>, f<trainer_2>>;

  IC(configurable_v3_t::A);
  IC(configurable_v3_t::B);
  // IC(configurable_v3_t::C);
  IC(configurable_v3_t::D);
  IC(configurable_v3_t::E::name());
  //TODO
}